export default function Contact() {
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-white to-blue-50/30">
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-lg border border-blue-100/50">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">contact@latilab.edu</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-lg border border-blue-100/50">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">University Campus, Building A, Room 101</p>
                    </div>
                  </div>
