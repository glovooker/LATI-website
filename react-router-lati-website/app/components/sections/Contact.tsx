                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base-content/70">contact@latilab.edu</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base-content/70">University Campus, Building A, Room 101</p>
                                        </div>
                                    </div>

                                    <div className="flex items-center space-x-4">
                                        <div className="avatar placeholder">
                                            <div className="bg-success text-success-content rounded-full w-12 h-12 flex items-center justify-center">
                                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base-content/70">Monday - Friday, 9:00 AM - 5:00 PM</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Social Links */ }
                            <div>
                                <h4 className="text-lg font-semibold mb-4">Follow Our Research</h4>
                                <div className="flex space-x-4">
                                    ...
                                    <a href="#" className="btn btn-circle btn-neutral">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
